...
const comparisonFeatures = [
    ...
    {
        category: 'Préqualification',
        label: 'Vérification profil / intérêt / budget',
        leads: false,
        ready: true,
        done: true
    },
        ...
        <div className="overflow-hidden bg-white">
                            ...
                            <ScrollReveal key={i} delay={i * 0.1}>
                                ...
                                >
                                    {plan.featured && (
                                        <>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    className="absolute inset-0 bg-gradient-to-br from-[#FFEA5E]/5 to-[#FFEA5E]/2"/>
                                                <div
                                    ...
                                    <div className="relative z-10 flex flex-col flex-1 justify-between h-full">
                                        ...
                                        <div className="mb-6">
                                            <p className="text-[#E5CB1B] text-xs font-semibold mb-2 uppercase tracking-wide"
                                               data-part="tagline">
                                                {t.offresPage.plans[i].tagline}
                                            </p>

                                            <p className="text-[#111827]/45 text-sm leading-relaxed"
                                        ...
                                        <div className="mb-6 pb-6 border-b border-[#111827]/[0.06] min-h-[6.5rem]"
                                             data-part="price">
                                            <div className="flex items-baseline gap-1.5">
                                                <span
                                                    className="font-heading font-bold text-4xl text-[#111827]">{plan.price}</span>
                                                <span
                                                    className="text-[#111827]/40 text-base">{t.offresPage.perMonth}</span>
                                            </div>
                                            <div
                                        ...
                                        <div className="mb-4 min-h-[11.5rem] flex flex-col" data-part="features">
                                            <ul className="space-y-3 flex-1">
                                                {(expandedCards[plan.id]
                                                    ...
                                                    <li key={j}
                                                        className="flex items-start gap-2.5 text-[#111827]/55 text-sm">
                                                        <CheckCircle2 size={15}
                                                                      className="text-[#E5CB1B] flex-shrink-0 mt-0.5"/>
                                    ...
                                    {features.map((feature, idx) => (
                                        <tr key={idx}
                                            ...
                                            <td className="text-center p-4">
                                                {feature.leads ? (
                                                    <div
                                                        className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-[#008A60]">
            ...
            <section className="py-8 px-6 bg-white">
                <div className="max-w-4xl mx-auto text-center">
                    <ScrollReveal>
                        <div
                            className="card-glass border border-[#EAB308]/20 p-12 rounded-3xl glow-brand relative overflow-hidden">
                            <div
                                className="absolute -top-24 -right-24 w-64 h-64 bg-[#EAB308]/5 rounded-full blur-[80px]"/>
                            <div
                                className="absolute -bottom-24 -left-24 w-64 h-64 bg-[#FACC15]/5 rounded-full blur-[80px]"/>
