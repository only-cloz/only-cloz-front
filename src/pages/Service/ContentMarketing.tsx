    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center mb-24">
        <div className="flex flex-wrap justify-center gap-2 mb-6">
          {rewards.map((reward, idx) => (
            <span key={idx} className="inline-flex items-center gap-1 text-[#7C3AED] text-xs px-2 py-1">
              <Award size={12} /> {reward}
            </span>
          ))}
        </div>
        <p className="text-sm text-[#7C3AED] mb-4">Content Marketing</p>
        <h1 className="text-5xl lg:text-6xl font-bold text-[#111827] mb-6 leading-tight">
          Produisez le contenu que <br />
          <span className="text-[#7C3AED]">votre cible cherche vraiment</span>
        </h1>
      ...
      <div className="max-w-3xl mx-auto mb-24">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="text-center p-4 border border-[#7C3AED]/10 rounded-xl">
