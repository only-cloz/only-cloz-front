  ...
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
        <div>
          <p className="text-sm text-[#EAB308] mb-4">Google Ads Expert</p>
      ...
      <div className="border-t border-b border-[#EAB308]/10 py-12 mb-24">
      ...
      <div className="bg-[#F9FAFB] rounded-2xl p-8 mb-24">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <p className="text-xs uppercase tracking-wider text-[#EAB308] mb-2">Ressource</p>
      ...
      {/* CTA finale - minimal */}
      <div className="text-center py-12 border-t border-[#EAB308]/10">
