...
const projects = [
    {
        ...
        gradient: 'from-[#FFE957] to-[#FFD700]', // Changé en jaune OnlyCloz
        textColor: '#0F172A', // Texte sombre pour le cercle jaune
    },
    {
        ...
        textColor: '#ffffff', // Texte blanc pour le cercle turquoise
    },
    {
        ...
        textColor: '#ffffff', // Texte blanc pour le cercle violet
    },
]
                    ...
                    <div className="relative z-20 w-full px-4 mt-8">
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-6 lg:gap-8 max-w-5xl mx-auto">
                            {projects.map((project, idx) => {
                                ...
                                // Déterminer la couleur du texte en fonction de l'index
                                const textColor = idx === 0 ? '#0F172A' : '#ffffff'
                                    ...
                                    <div key={idx} className="flex flex-col items-center">
                                        ...
                                        >
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noreferrer"
                                                className={`relative w-44 h-44 sm:w-52 sm:h-52 rounded-full bg-gradient-to-br ${project.gradient} p-1.5 shadow-2xl transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-1 hover:shadow-3xl group cursor-pointer block`}
                                            >
                                                <div
                                                    className="w-full h-full rounded-full bg-white/10 flex items-center justify-center backdrop-blur-sm border border-white/30 group-hover:border-white/50 group-hover:bg-white/20">
