...
const stats = [
  { value: 500, suffix: '+', label: 'Leads livrés / mois', icon: Target, color: 'from-[#EAB308]/10 to-[#FACC15]/5' },
  { value: 98,  suffix: '%', label: 'Conformité RGPD',     icon: Shield,    color: 'from-[#10B981]/10 to-[#34D399]/5' },
  { value: 3,   suffix: 'x', label: 'ROI moyen clients',   icon: TrendingUp, color: 'from-[#FACC15]/10 to-[#EC4899]/5' },
  { value: 48,  suffix: 'h', label: 'Délai de livraison',  icon: Clock,     color: 'from-[#F59E0B]/10 to-[#EAB308]/5' },
]
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {stats.map(({ value, suffix, label, icon: Icon, color }, i) => (
            <ScrollReveal key={i} delay={i * 0.1}>
              <div className="card-glass p-7 text-center group hover:border-[#EAB308]/30 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
