        ...
        <div className="mt-14 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {values.map((v, i) => (
            <ScrollReveal key={i} delay={i * 0.08}>
              <div className="card-glass p-7 group hover:border-[#EAB308]/25 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
